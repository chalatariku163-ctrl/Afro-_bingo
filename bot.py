...
# ==================================================
    ...
    await query.edit_message_text(
        ...
        "💸 WITHDRAWAL\n\n"
        "Mee amount ati baafachuu barbaaddu "
        "lakkoofsaan ergi.\n\n"
        "Fakkeenya: 50",
...
# ==================================================
    ...
    await query.edit_message_text(
        ...
        "1️⃣ Deposit godhi.\n"
        "2️⃣ Bingo Card bitadhu.\n"
        "3️⃣ Admin game yeroo banu "
        "Play Game cuqaasi.\n"
        "4️⃣ Lakkoofsa waamame card kee "
        "irratti mallatteessi.\n"
        "5️⃣ Yoo pattern Bingo guutte "
        "BINGO cuqaasi.",
...
# ==================================================
    ...
    await context.bot.send_message(
        ...
        text=(
            ...
            "✅ Withdrawal kee approved ta'eera.\n\n"
...
# ==================================================
    ...
    await context.bot.send_message(
        ...
        text="❌ Withdrawal request kee reject ta'eera."
...
# ==================================================
    ...
    await context.bot.send_message(
        ...
        text="❌ Payment proof kee reject ta'eera."
